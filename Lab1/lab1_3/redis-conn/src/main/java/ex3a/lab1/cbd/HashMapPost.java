...
public class HashMapPost { 
    public static String USERS_KEY = "users_hash"; // Key set (definida para) for users' name -> this means that the users' names are stored in the key "users" 
  
    public static void main(String[] args) { 
        Jedis jedis = new Jedis(); 
        // some users 
        String[] users = { "Rúben", "Rita", "Toneca", "Manel" }; 
